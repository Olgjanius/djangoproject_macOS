...
class conditional:
    ...
    print("stopwords english:  ", ",".join(stopwords.words("english")))

    # nur die ersten 10 engl. Stopwörter
...
with open('../docsources/corporatexte.txt', 'w+') as file:
